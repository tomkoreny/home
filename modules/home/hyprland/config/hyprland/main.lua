...
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("media-control next"), locked)
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("media-control play-pause"), locked)
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("media-control play-pause"), locked)
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("media-control previous"), locked)
