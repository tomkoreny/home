...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd("qs -c tom-bar ipc call launcher cameras"))
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("qs -c tom-bar ipc call launcher clipboard"))
