...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd("@cameraLauncherCommand@"))
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("@clipboardLauncherCommand@"))
...
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl --player=mpv,%any next"), locked)
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("playerctl --player=mpv,%any play-pause"), locked)
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl --player=mpv,%any play-pause"), locked)
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl --player=mpv,%any previous"), locked)
